const CACHE='jeebli-v5';
const ASSETS=['./','./index.html','./styles.css','./config.js','./app.js','./tracking.js','./admin-gate.js','./driver.html','./driver.css','./driver.js','./manifest.webmanifest'];
