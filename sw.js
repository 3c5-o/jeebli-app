const CACHE='jeebli-customer-v23';
const CORE=[
  './','./index.html','./styles.css','./brand.css','./customer-v2.css','./customer-v3.css','./customer-services.css','./customer-avatar.css','./customer-polish.css','./customer-contrast.css','./customer-lux.css','./customer-home-v2.css','./customer-service-images.css','./customer-mobile-fixes.css','./customer-final.css','./customer-v1-hotfix.css','./customer-media.css','./customer-completion.css',
  './config.js','./app.js','./tracking.js','./brand.js','./customer-areas.js','./customer-v2.js','./customer-v3.js','./customer-v3-bridge.js','./customer-services.js','./customer-starex.js','./customer-launch.js','./customer-avatar.js','./customer-addresses.js','./customer-system-notify.js','./customer-polish.js','./customer-ux.js','./customer-push.js','./customer-lux.js','./customer-home-v2.js','./customer-service-images.js','./customer-mobile-fixes.js','./customer-final.js','./customer-media.js','./customer-completion.js',
